 ...
 */static int select_idle_core(struct task_struct *p, int core, struct cpumask *cpus, int *idle_cpu)static int select_idle_core(struct task_struct *p, struct sched_domain *sd, int target)
{
	bool idle = true;
	int cpu;
